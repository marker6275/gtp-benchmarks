                 ...
                 (list
                  (cons
                   ...
                   (delegating-instanceof
                    (delegating-class/c
                     (list (cons 'players (delegating-listof (delegating-instanceof (delegating-class/c (list (cons 'order (sealing-adapter))) (list) (list))))))
                     (list
                      (cons
                       'internal%
                       (delegating-and/c
                        (delegating-class/c
                         (list (cons 'player (delegating-instanceof (delegating-class/c (list (cons 'order (sealing-adapter))) (list) (list)))))
                         (list)
                         (list
                          (cons
                           'get-field:player
                           (delegating-> 0 (list) (any/c-adapter) (list (cons 0 (delegating-instanceof (delegating-class/c (list (cons 'order (sealing-adapter))) (list) (list)))))))
                          (cons
                           'set-field:player
