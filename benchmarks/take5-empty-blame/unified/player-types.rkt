(module player-types typed/racket/shallow
  (#%module-begin
   (provide Player% Player)
   (require "../../../utilities/require-typed-check-provide-transient.rkt" "basics-types.rkt" "deck-types.rkt" "card-adapted.rkt" "stack-types.rkt" typed/racket/class)
