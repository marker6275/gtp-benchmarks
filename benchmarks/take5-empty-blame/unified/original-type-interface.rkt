(module type-interface typed/racket/shallow
  (#%module-begin
   ...
   (define-type
    Player%
    (Class
     (init-field (n Name) (order Any #:optional))
   ...
   (require/typed/check/provide "dealer.rkt" (create-dealer (-> (Listof Player) Dealer)))
   (require/typed/check/provide "base-player.rkt" (player% Player%))))
