(module stack typed/racket/shallow
  (#%module-begin
   ...
   (require "../../../utilities/require-typed-check-provide-transient.rkt" "card-adapted.rkt" "stack-types.rkt" "basics-types.rkt")
   (struct card ((face : Face) (bulls : Bulls)) #:prefab #:type-name Card)
   (require "../../../utilities/require-typed-check-provide-transient.rkt" (prefix-in list: (only-in racket/base length)))
   (require "../../../utilities/require-typed-check-provide-transient.rkt" (only-in racket/list first))
